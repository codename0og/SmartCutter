...
title SmartCutter installer

echo Welcome to the SmartCutter installer!
echo.
...
echo SmartCutter has been installed successfully!
echo.
pause
exit /b 0
...
uv pip install torch==2.7.1 torchaudio==2.7.1 --upgrade --index-url https://download.pytorch.org/whl/cu128 || goto :error
